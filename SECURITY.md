...
Replace this section with the supported versions for `tapship`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `tapship` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in tapship.
